...
mkdir -p temp
cd temp
curl -sSLo LimeStitch.tar.gz https://raw.githubusercontent.com/"${MAINTAINER_REPO}"/Pterodactyl-AutoThemes/${SCRIPT_VERSION}/themes/version0.7.19/LimeStitch/LimeStitch.tar.gz
